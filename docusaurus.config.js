...
const config = {
  title: 'Userana',
  tagline: 'User Analytics',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://userana.com',
  ...
  organizationName: 'userana.com', // Usually your GitHub org/user name.
  projectName: 'ana-front', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/userana-com',
            label: 'Login',
            position: 'right',
          },
        ],
